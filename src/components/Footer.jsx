    ...
    <footer ref={ref} className="relative bg-ink py-10 md:py-14 border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-6 md:px-10 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <motion.p
          ...
          className="font-serif italic text-[1rem] text-paper/70"
        >
        ...
        <motion.p
          ...
          className="font-body text-[0.52rem] tracking-[0.25em] uppercase text-paper/55 text-center"
        >
        ...
        >
          <a
            ...
            className="font-body text-[0.55rem] tracking-[0.25em] uppercase text-paper/70 hover:text-accent transition-colors duration-300"
          >
            Instagram
          </a>
