...
export default function AboutPreview() {
  ...
  return (
    <section id="about" ref={ref} className="relative py-32 md:py-44 bg-chalk">
      <div className="max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 md:gap-0">
        ...
        >
          <div className="w-4 h-px bg-cobalt mt-1.5 shrink-0" />
        ...
        <div className="md:col-span-8 md:col-start-4">
          <motion.p
            ...
            className="font-serif text-[1.5rem] md:text-[2rem] text-ink leading-relaxed font-light"
          >
            {SHORT_BIO}
          </motion.p>
          ...
          <AnimatePresence initial={false}>
            {expanded && (
              ...
              >
                <div className="mt-8 space-y-5 border-l border-veil pl-8">
                  {EXTENDED_BIO.trim().split('\n\n').map((para, i) => (
                    <p key={i} className="font-body text-[0.88rem] text-smoke leading-relaxed">
                      {para}
                    </p>
                  ))}
                </div>
          ...
          <motion.button
            ...
            className="mt-10 group flex items-center gap-4 font-body text-[0.58rem] tracking-[0.3em] uppercase text-ash hover:text-cobalt transition-colors duration-300"
          >
